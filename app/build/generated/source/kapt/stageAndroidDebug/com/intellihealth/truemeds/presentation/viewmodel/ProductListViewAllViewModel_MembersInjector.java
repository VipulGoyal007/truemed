...
public final class ProductListViewAllViewModel_MembersInjector implements MembersInjector<ProductListViewAllViewModel> {
  ...
  public ProductListViewAllViewModel_MembersInjector(
  ...
  public static MembersInjector<ProductListViewAllViewModel> create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new ProductListViewAllViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(ProductListViewAllViewModel instance) {
