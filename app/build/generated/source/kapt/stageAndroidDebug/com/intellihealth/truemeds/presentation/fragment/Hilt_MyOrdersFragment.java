...
public abstract class Hilt_MyOrdersFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyOrdersFragment() {
    super();
  }

  Hilt_MyOrdersFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyOrdersFragment_GeneratedInjector) this.generatedComponent()).injectMyOrdersFragment(UnsafeCasts.<MyOrdersFragment>unsafeCast(this));
    }
  }
