...
public class BrandTypeItemBindingImpl extends BrandTypeItemBinding implements com.intellihealth.truemeds.generated.callback.OnClickListener.Listener {
    ...
    public BrandTypeItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private BrandTypeItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback44 = new com.intellihealth.truemeds.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.customRadioOrder.setOnClickListener(mCallback44);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewModelJavaLangObjectNull) {
            ...
            viewModel.setCheckboxBrandClicked(itemPosition);
        }
    }
    // dirty flag
