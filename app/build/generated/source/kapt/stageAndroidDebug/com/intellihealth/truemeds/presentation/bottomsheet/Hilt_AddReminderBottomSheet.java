...
public abstract class Hilt_AddReminderBottomSheet extends BottomSheet implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddReminderBottomSheet_GeneratedInjector) this.generatedComponent()).injectAddReminderBottomSheet(UnsafeCasts.<AddReminderBottomSheet>unsafeCast(this));
    }
  }
