...
public abstract class Hilt_LoginMobileNumberFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginMobileNumberFragment() {
    super();
  }

  Hilt_LoginMobileNumberFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginMobileNumberFragment_GeneratedInjector) this.generatedComponent()).injectLoginMobileNumberFragment(UnsafeCasts.<LoginMobileNumberFragment>unsafeCast(this));
    }
  }
