...
public final class OrderSummaryViewModel_Factory implements Factory<OrderSummaryViewModel> {
  ...
  public OrderSummaryViewModel_Factory(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public OrderSummaryViewModel get() {
    OrderSummaryViewModel instance = newInstance();
  ...
  public static OrderSummaryViewModel_Factory create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new OrderSummaryViewModel_Factory(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static OrderSummaryViewModel newInstance() {
