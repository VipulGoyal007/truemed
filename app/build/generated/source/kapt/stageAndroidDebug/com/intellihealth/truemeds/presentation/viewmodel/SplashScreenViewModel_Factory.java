...
public final class SplashScreenViewModel_Factory implements Factory<SplashScreenViewModel> {
  ...
  public SplashScreenViewModel_Factory(Provider<SplashScreenUseCase> splashScreenUseCaseProvider,
    ...
    this.splashScreenUseCaseProvider = splashScreenUseCaseProvider;
  ...
  public SplashScreenViewModel get() {
    SplashScreenViewModel instance = newInstance(splashScreenUseCaseProvider.get());
  ...
  public static SplashScreenViewModel_Factory create(
      Provider<SplashScreenUseCase> splashScreenUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new SplashScreenViewModel_Factory(splashScreenUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static SplashScreenViewModel newInstance(SplashScreenUseCase splashScreenUseCase) {
    return new SplashScreenViewModel(splashScreenUseCase);
  }
}
