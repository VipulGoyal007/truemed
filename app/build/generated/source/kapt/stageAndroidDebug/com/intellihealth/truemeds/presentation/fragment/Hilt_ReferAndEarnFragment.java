...
public abstract class Hilt_ReferAndEarnFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReferAndEarnFragment() {
    super();
  }

  Hilt_ReferAndEarnFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReferAndEarnFragment_GeneratedInjector) this.generatedComponent()).injectReferAndEarnFragment(UnsafeCasts.<ReferAndEarnFragment>unsafeCast(this));
    }
  }
