...
public abstract class Hilt_PaymentChangeSelectionBottomSheet extends BottomSheet implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentChangeSelectionBottomSheet_GeneratedInjector) this.generatedComponent()).injectPaymentChangeSelectionBottomSheet(UnsafeCasts.<PaymentChangeSelectionBottomSheet>unsafeCast(this));
    }
  }
