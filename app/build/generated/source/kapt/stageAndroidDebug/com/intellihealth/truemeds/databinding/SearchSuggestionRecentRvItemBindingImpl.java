...
public class SearchSuggestionRecentRvItemBindingImpl extends SearchSuggestionRecentRvItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.searchSuggestionItem, 1);
    }
    // views
    @NonNull
    ...
    public SearchSuggestionRecentRvItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private SearchSuggestionRecentRvItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (com.intellihealth.salt.views.SearchSuggestionItem) bindings[1]
            );
