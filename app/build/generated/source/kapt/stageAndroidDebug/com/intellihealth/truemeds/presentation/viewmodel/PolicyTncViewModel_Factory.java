...
public final class PolicyTncViewModel_Factory implements Factory<PolicyTncViewModel> {
  ...
  public PolicyTncViewModel_Factory(Provider<HelpFaqTncUseCase> helpFaqTncUseCaseProvider,
  ...
  @Override
  public PolicyTncViewModel get() {
    PolicyTncViewModel instance = newInstance(helpFaqTncUseCaseProvider.get());
  ...
  public static PolicyTncViewModel_Factory create(
      Provider<HelpFaqTncUseCase> helpFaqTncUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new PolicyTncViewModel_Factory(helpFaqTncUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static PolicyTncViewModel newInstance(HelpFaqTncUseCase helpFaqTncUseCase) {
    return new PolicyTncViewModel(helpFaqTncUseCase);
  }
}
