...
public final class OrdersTabViewModel_Factory implements Factory<OrdersTabViewModel> {
  private final Provider<HomePageUseCase> homePageUseCaseProvider;

  private final Provider<ManagePatientUseCase> managePatientUseCaseProvider;
  ...
  public OrdersTabViewModel_Factory(Provider<HomePageUseCase> homePageUseCaseProvider,
      Provider<ManagePatientUseCase> managePatientUseCaseProvider,
    ...
    this.managePatientUseCaseProvider = managePatientUseCaseProvider;
  ...
  @Override
  public OrdersTabViewModel get() {
    OrdersTabViewModel instance = newInstance(homePageUseCaseProvider.get(), managePatientUseCaseProvider.get(), reorderUseCaseProvider.get());
  ...
  public static OrdersTabViewModel_Factory create(Provider<HomePageUseCase> homePageUseCaseProvider,
      Provider<ManagePatientUseCase> managePatientUseCaseProvider,
      Provider<ReorderUseCase> reorderUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new OrdersTabViewModel_Factory(homePageUseCaseProvider, managePatientUseCaseProvider, reorderUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static OrdersTabViewModel newInstance(HomePageUseCase homePageUseCase,
      ManagePatientUseCase managePatientUseCase, ReorderUseCase reorderUseCase) {
    return new OrdersTabViewModel(homePageUseCase, managePatientUseCase, reorderUseCase);
  }
}
