...
public abstract class Hilt_PastPrescriptionBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PastPrescriptionBottomSheet() {
    super();
  }

  Hilt_PastPrescriptionBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PastPrescriptionBottomSheet_GeneratedInjector) this.generatedComponent()).injectPastPrescriptionBottomSheet(UnsafeCasts.<PastPrescriptionBottomSheet>unsafeCast(this));
    }
  }
