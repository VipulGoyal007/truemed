...
public class SubCategoryTypeItemBindingImpl extends SubCategoryTypeItemBinding implements com.intellihealth.truemeds.generated.callback.OnClickListener.Listener {
    ...
    public SubCategoryTypeItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private SubCategoryTypeItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback59 = new com.intellihealth.truemeds.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.customRadioOrder.setOnClickListener(mCallback59);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewModelJavaLangObjectNull) {
            ...
            viewModel.setRadioSubCategoryClicked(itemPosition);
        }
    }
    // dirty flag
