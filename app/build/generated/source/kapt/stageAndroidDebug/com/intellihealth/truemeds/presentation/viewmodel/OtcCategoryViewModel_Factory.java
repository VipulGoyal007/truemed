...
public final class OtcCategoryViewModel_Factory implements Factory<OtcCategoryViewModel> {
  private final Provider<PersonalCareUseCase> personalCareUseCaseProvider;
  ...
  public OtcCategoryViewModel_Factory(Provider<PersonalCareUseCase> personalCareUseCaseProvider,
    ...
    this.personalCareUseCaseProvider = personalCareUseCaseProvider;
  ...
  @Override
  public OtcCategoryViewModel get() {
    OtcCategoryViewModel instance = newInstance(personalCareUseCaseProvider.get());
  ...
  public static OtcCategoryViewModel_Factory create(
      Provider<PersonalCareUseCase> personalCareUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new OtcCategoryViewModel_Factory(personalCareUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static OtcCategoryViewModel newInstance(PersonalCareUseCase personalCareUseCase) {
    return new OtcCategoryViewModel(personalCareUseCase);
  }
}
