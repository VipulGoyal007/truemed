...
public final class AccountTabViewModel_Factory implements Factory<AccountTabViewModel> {
  ...
  public AccountTabViewModel_Factory(Provider<HomePageUseCase> homePageUseCaseProvider,
  ...
  public AccountTabViewModel get() {
    AccountTabViewModel instance = newInstance(homePageUseCaseProvider.get());
  ...
  public static AccountTabViewModel_Factory create(
      Provider<HomePageUseCase> homePageUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new AccountTabViewModel_Factory(homePageUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static AccountTabViewModel newInstance(HomePageUseCase homePageUseCase) {
    return new AccountTabViewModel(homePageUseCase);
  }
}
