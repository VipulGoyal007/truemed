...
public final class ReminderViewModel_Factory implements Factory<ReminderViewModel> {
  ...
  public ReminderViewModel_Factory(Provider<ReminderUseCase> reminderUseCaseProvider,
  ...
  public ReminderViewModel get() {
    ReminderViewModel instance = newInstance(reminderUseCaseProvider.get(), contextProvider.get());
  ...
  public static ReminderViewModel_Factory create(Provider<ReminderUseCase> reminderUseCaseProvider,
      Provider<Context> contextProvider, Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new ReminderViewModel_Factory(reminderUseCaseProvider, contextProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static ReminderViewModel newInstance(ReminderUseCase reminderUseCase, Context context) {
    return new ReminderViewModel(reminderUseCase, context);
  }
}
