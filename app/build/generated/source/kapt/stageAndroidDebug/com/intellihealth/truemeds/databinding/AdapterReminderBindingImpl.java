...
public class AdapterReminderBindingImpl extends AdapterReminderBinding  {
    ...
    public AdapterReminderBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private AdapterReminderBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (androidx.constraintlayout.widget.ConstraintLayout) bindings[0]
            , (com.intellihealth.salt.views.cards.AddressPatientDetailsCard) bindings[1]
            );
        this.clReminderLayout.setTag(null);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.reminder.setUpData(addressCardData);
        }
    }
