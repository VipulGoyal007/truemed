...
public class OrderTypeItemBindingImpl extends OrderTypeItemBinding implements com.intellihealth.truemeds.generated.callback.OnClickListener.Listener {
    ...
    public OrderTypeItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private OrderTypeItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback16 = new com.intellihealth.truemeds.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x4L) != 0) {
            ...
            this.customRadioOrder.setOnClickListener(mCallback16);
        }
    }
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        ...
        if (viewModelJavaLangObjectNull) {
            ...
            viewModel.setRadioOrderClicked(itemPosition);
        }
    }
    // dirty flag
