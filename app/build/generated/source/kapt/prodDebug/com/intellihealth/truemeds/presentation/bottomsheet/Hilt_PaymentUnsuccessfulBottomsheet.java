...
public abstract class Hilt_PaymentUnsuccessfulBottomsheet extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PaymentUnsuccessfulBottomsheet() {
    super();
  }

  Hilt_PaymentUnsuccessfulBottomsheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PaymentUnsuccessfulBottomsheet_GeneratedInjector) this.generatedComponent()).injectPaymentUnsuccessfulBottomsheet(UnsafeCasts.<PaymentUnsuccessfulBottomsheet>unsafeCast(this));
    }
  }
