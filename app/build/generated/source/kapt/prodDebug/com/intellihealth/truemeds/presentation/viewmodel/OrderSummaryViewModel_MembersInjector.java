...
public final class OrderSummaryViewModel_MembersInjector implements MembersInjector<OrderSummaryViewModel> {
  ...
  public OrderSummaryViewModel_MembersInjector(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public static MembersInjector<OrderSummaryViewModel> create(
      ...
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new OrderSummaryViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(OrderSummaryViewModel instance) {
