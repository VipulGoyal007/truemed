...
public final class SplashScreenViewModel_MembersInjector implements MembersInjector<SplashScreenViewModel> {
  ...
  public SplashScreenViewModel_MembersInjector(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public static MembersInjector<SplashScreenViewModel> create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new SplashScreenViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(SplashScreenViewModel instance) {
