...
public abstract class Hilt_ReferNowFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReferNowFragment() {
    super();
  }

  Hilt_ReferNowFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReferNowFragment_GeneratedInjector) this.generatedComponent()).injectReferNowFragment(UnsafeCasts.<ReferNowFragment>unsafeCast(this));
    }
  }
