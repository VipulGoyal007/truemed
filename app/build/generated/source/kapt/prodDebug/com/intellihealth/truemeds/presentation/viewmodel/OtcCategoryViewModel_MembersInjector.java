...
public final class OtcCategoryViewModel_MembersInjector implements MembersInjector<OtcCategoryViewModel> {
  ...
  public OtcCategoryViewModel_MembersInjector(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public static MembersInjector<OtcCategoryViewModel> create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new OtcCategoryViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(OtcCategoryViewModel instance) {
