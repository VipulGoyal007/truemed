...
public final class CouponViewModel_Factory implements Factory<CouponViewModel> {
  ...
  public CouponViewModel_Factory(Provider<Context> contextProvider,
  ...
  public CouponViewModel get() {
    CouponViewModel instance = newInstance(contextProvider.get());
  ...
  public static CouponViewModel_Factory create(Provider<Context> contextProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new CouponViewModel_Factory(contextProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static CouponViewModel newInstance(Context context) {
    return new CouponViewModel(context);
  }
}
