...
public abstract class Hilt_ReferEarnFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReferEarnFragment() {
    super();
  }

  Hilt_ReferEarnFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReferEarnFragment_GeneratedInjector) this.generatedComponent()).injectReferEarnFragment(UnsafeCasts.<ReferEarnFragment>unsafeCast(this));
    }
  }
