...
public abstract class Hilt_ViewBillDetailsBottomSheet extends BottomSheet implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewBillDetailsBottomSheet_GeneratedInjector) this.generatedComponent()).injectViewBillDetailsBottomSheet(UnsafeCasts.<ViewBillDetailsBottomSheet>unsafeCast(this));
    }
  }
