...
public class ActivityHelpSubcategoryBindingImpl extends ActivityHelpSubcategoryBinding implements com.intellihealth.truemeds.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tmTopHeader, 5);
        sViewsWithIds.put(R.id.llBottom, 6);
        sViewsWithIds.put(R.id.tvStillHaveQuestion, 7);
    }
    // views
    @NonNull
    ...
    public ActivityHelpSubcategoryBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityHelpSubcategoryBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.rvHelpSubCategoryList.setTag(null);
        this.shimmerViewContainer.setTag(null);
        setRootTag(root);
        // listeners
        mCallback42 = new com.intellihealth.truemeds.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        java.util.List<com.intellihealth.truemeds.data.model.helpfaqtnc.HelpCategoryResponse.CategoryList> viewModelHelpListApiResponse = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (viewModel != null) {
                        // read viewModel.helpListApiResponse
                        viewModelHelpListApiResponse = viewModel.getHelpListApiResponse();
                    }
            }
        }
        // batch finished
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.btnLinkSmall.setOnClickListener(mCallback42);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1

            this.rvHelpSubCategoryList.setVisibility(viewModelShowHelpListViewViewVISIBLEViewGONE);
        }
        if ((dirtyFlags & 0xcL) != 0) {
            // api target 1

            com.intellihealth.truemeds.presentation.bindingadapter.HelpSubCategoryListBindingAdapterKt.setHelpSubCategoryList(this.rvHelpSubCategoryList, viewModelHelpListApiResponse, viewModel);
        }
        if ((dirtyFlags & 0xeL) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 3 (0x4L): null
        flag 4 (0x5L): androidx.databinding.ViewDataBinding.safeUnbox(viewModel.showShimmer.getValue()) ? View.VISIBLE : View.GONE
        flag 5 (0x6L): androidx.databinding.ViewDataBinding.safeUnbox(viewModel.showShimmer.getValue()) ? View.VISIBLE : View.GONE
        flag 6 (0x7L): androidx.databinding.ViewDataBinding.safeUnbox(viewModel.showHelpListView.getValue()) ? View.VISIBLE : View.GONE
