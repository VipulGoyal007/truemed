...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.topLoginBanner, 1);
        sViewsWithIds.put(R.id.login_vpBanner, 2);
        sViewsWithIds.put(R.id.skipButton, 3);
        sViewsWithIds.put(R.id.bottomSheet, 4);
        sViewsWithIds.put(R.id.login_bannerIndicator, 5);
        sViewsWithIds.put(R.id.login_frame_layout, 6);
    }
    // views
    @NonNull
    ...
    private ActivityLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.intellihealth.salt.views.PageIndicator) bindings[5]
