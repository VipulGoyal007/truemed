...
public abstract class Hilt_LoginOtpFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoginOtpFragment() {
    super();
  }

  Hilt_LoginOtpFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoginOtpFragment_GeneratedInjector) this.generatedComponent()).injectLoginOtpFragment(UnsafeCasts.<LoginOtpFragment>unsafeCast(this));
    }
  }
