...
public class SearchResultUpdatedUiItemBindingImpl extends SearchResultUpdatedUiItemBinding  {
    ...
    public SearchResultUpdatedUiItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private SearchResultUpdatedUiItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x12L) != 0) {
            ...
            this.chipName.setChipTitle(itemMedicineName);
        }
    }
