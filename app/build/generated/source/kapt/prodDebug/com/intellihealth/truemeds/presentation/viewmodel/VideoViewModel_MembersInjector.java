...
public final class VideoViewModel_MembersInjector implements MembersInjector<VideoViewModel> {
  ...
  public VideoViewModel_MembersInjector(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public static MembersInjector<VideoViewModel> create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new VideoViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(VideoViewModel instance) {
