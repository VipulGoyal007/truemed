...
public final class SubstitutePageViewModel_Factory implements Factory<SubstitutePageViewModel> {
  ...
  public SubstitutePageViewModel_Factory(Provider<LoginUseCase> loginUseCaseProvider,
  ...
  @Override
  public SubstitutePageViewModel get() {
    SubstitutePageViewModel instance = newInstance(loginUseCaseProvider.get());
  ...
  public static SubstitutePageViewModel_Factory create(Provider<LoginUseCase> loginUseCaseProvider,
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new SubstitutePageViewModel_Factory(loginUseCaseProvider, localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  public static SubstitutePageViewModel newInstance(LoginUseCase loginUseCase) {
    return new SubstitutePageViewModel(loginUseCase);
  }
}
