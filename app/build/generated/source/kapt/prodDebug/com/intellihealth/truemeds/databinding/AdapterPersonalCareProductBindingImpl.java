...
public class AdapterPersonalCareProductBindingImpl extends AdapterPersonalCareProductBinding  {
    ...
    public AdapterPersonalCareProductBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private AdapterPersonalCareProductBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.productCardCallback == variableId) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            this.productCard.setCrossSellingCallback(productCardCallback);
        }
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1

            this.productCard.setCrossSellingData(data);
        }
    }
    ...
    /* flag mapping
        flag 0 (0x1L): productCardCallback
        flag 1 (0x2L): data
        flag 2 (0x3L): null
    flag mapping end*/
    //end
