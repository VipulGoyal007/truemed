...
public final class VideoFaqViewModel_MembersInjector implements MembersInjector<VideoFaqViewModel> {
  ...
  public VideoFaqViewModel_MembersInjector(Provider<LocalDbUseCase> localDbUseCaseProvider,
  ...
  public static MembersInjector<VideoFaqViewModel> create(
      Provider<LocalDbUseCase> localDbUseCaseProvider,
      Provider<OrderFlowUseCase> orderFlowUseCaseProvider,
      Provider<CouponUseCase> couponUseCaseProvider,
      Provider<SdkEventUseCase> sdkEventUseCaseProvider) {
    return new VideoFaqViewModel_MembersInjector(localDbUseCaseProvider, orderFlowUseCaseProvider, couponUseCaseProvider, sdkEventUseCaseProvider);
  }

  @Override
  public void injectMembers(VideoFaqViewModel instance) {
