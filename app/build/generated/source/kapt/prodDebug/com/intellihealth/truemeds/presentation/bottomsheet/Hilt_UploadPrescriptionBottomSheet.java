...
public abstract class Hilt_UploadPrescriptionBottomSheet extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UploadPrescriptionBottomSheet() {
    super();
  }

  Hilt_UploadPrescriptionBottomSheet(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UploadPrescriptionBottomSheet_GeneratedInjector) this.generatedComponent()).injectUploadPrescriptionBottomSheet(UnsafeCasts.<UploadPrescriptionBottomSheet>unsafeCast(this));
    }
  }
