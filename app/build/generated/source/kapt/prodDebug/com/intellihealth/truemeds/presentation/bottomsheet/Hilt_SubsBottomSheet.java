...
public abstract class Hilt_SubsBottomSheet extends BottomSheet implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubsBottomSheet_GeneratedInjector) this.generatedComponent()).injectSubsBottomSheet(UnsafeCasts.<SubsBottomSheet>unsafeCast(this));
    }
  }
