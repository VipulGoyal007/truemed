...
public abstract class Hilt_MyReferralsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyReferralsFragment() {
    super();
  }

  Hilt_MyReferralsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyReferralsFragment_GeneratedInjector) this.generatedComponent()).injectMyReferralsFragment(UnsafeCasts.<MyReferralsFragment>unsafeCast(this));
    }
  }
